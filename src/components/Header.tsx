...
export default function Header() {
  return (
    <>
      {/* Top Info Bar */}
      <div className="bg-[#e6e6fc] flex items-start px-20 py-4">
        <div className="flex items-center justify-between w-full max-w-[1440px] mx-auto">
          <div className="flex items-center gap-1">
            ...
            <p className="font-[family-name:var(--font-poppins)] text-base text-black underline">
              info@nexus.com
            </p>
          </div>
          <div className="flex items-center gap-12 font-[family-name:var(--font-poppins)] text-base text-black">
      ...
      {/* Main Navbar */}
      <div className="backdrop-blur-sm bg-white flex items-center justify-between px-20 py-7 sticky top-0 z-50">
        <div className="flex items-center justify-between w-full max-w-[1440px] mx-auto">
          <Link href="/">
            <img alt="Nexus Logo" className="h-[22px] w-[140px] cursor-pointer" src="/logo.png" />
          </Link>
          <nav className="flex items-center gap-16 font-[family-name:var(--font-inter)] font-medium text-lg text-[#525252]">
            <Link href="/mattress">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="relative cursor-pointer">
              ...
              <div className="absolute -top-1 -right-1 bg-[#253f94] rounded-full w-5 h-5 flex items-center justify-center">
