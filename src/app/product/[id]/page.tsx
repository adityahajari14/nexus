      ...
      <div className="max-w-[1440px] mx-auto px-20 py-8">
        <div className="flex gap-8">
          ...
          <div className="flex flex-col gap-4 w-[580px]">
            <div className="bg-[#f5f7ff] w-full h-[400px] overflow-hidden rounded-lg">
              <img 
            ...
            <div className="flex gap-3">
              {product.images.slice(0, 4).map((image, index) => (
                <div 
                  key={index} 
                  className={`bg-[#f5f7ff] w-[90px] h-[90px] overflow-hidden rounded-lg cursor-pointer hover:opacity-80 transition-opacity ${index === 0 ? 'border-2 border-[#253f94]' : ''}`}
                >
                  <img 
                    src={image} 
          ...
          <div className="flex flex-col gap-4 flex-1">
            ...
            <div className="border border-[#d1d1d1] rounded-lg px-3 py-2 w-fit">
              <div className="flex gap-3 items-center">
                ...
                <p className="font-[family-name:var(--font-poppins)] text-base text-black">
                  4.5 | 342 Reviews
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-3">
                  <h1 className="font-[family-name:var(--font-poppins)] text-2xl text-[#141414] leading-tight">
                    {product.title}
                  </h1>
                  <div className="flex gap-3 items-center">
                    <p className="font-[family-name:var(--font-poppins)] font-semibold text-3xl text-black">
                      £{product.price}
                    </p>
                    <p className="font-[family-name:var(--font-poppins)] text-xl text-[#888] line-through">
            ...
            {/* Learn with Nexus */}
            <div className="border border-[#a6bbff] rounded-lg h-20 overflow-hidden relative" style={{ background: 'linear-gradient(96.06deg, #ABBFFF 0.22%, #E6F0FC 100%)' }}>
              <div className="absolute left-4 top-4">
                <p className="font-[family-name:var(--font-poppins)] font-medium text-base text-black capitalize">
                  Learn with Nexus
                </p>
                <p className="font-[family-name:var(--font-poppins)] text-sm text-black capitalize">
                  What is Plush Mattress
                </p>
              </div>
              <button className="absolute right-4 top-1/2 -translate-y-1/2 backdrop-blur-[2px] bg-white/8 border border-[#253f94] rounded-full px-4 py-2 flex items-center gap-2 hover:bg-white/20 transition-colors">
                <svg className="w-4 h-4" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M5 3l12 7-12 7V3z" fill="#253f94"/>
                </svg>
                <p className="font-[family-name:var(--font-poppins)] font-medium text-sm text-[#253f94] capitalize">
                  Watch Now
                </p>
              </button>
            </div>
        ...
        <div className="mt-16 bg-white rounded-lg p-8">
          <h2 className="font-[family-name:var(--font-poppins)] font-semibold text-2xl text-[#141414] mb-6">
            Product Description
          </h2>
          <p className="font-[family-name:var(--font-poppins)] text-base text-[#494949] leading-relaxed">
            {product.description}
        ...
        <div className="mt-16 bg-white rounded-lg p-8">
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-1">
                {[1, 2, 3, 4, 5].map((star) => (
                  <svg key={star} className="w-5 h-5" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.5 2l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1 3-6z" fill="#FFD700" stroke="#FFD700" strokeWidth="1.5"/>
                  </svg>
                ))}
              </div>
              ...
              <div key={review} className="border-b border-gray-200 pb-6 last:border-b-0">
                <div className="flex justify-between items-start mb-3">
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-3">
                      <p className="font-[family-name:var(--font-poppins)] font-semibold text-base text-[#141414]">
                        Sarah Johnson
                      </p>
                      <div className="flex items-center gap-1">
                        {[1, 2, 3, 4, 5].map((star) => (
          ...
          <button className="mt-6 border border-[#253f94] rounded-lg px-6 py-3 hover:bg-[#253f94] hover:text-white transition-colors">
            <p className="font-[family-name:var(--font-poppins)] font-medium text-base text-[#253f94] hover:text-white">
              Load More Reviews
            </p>
          </button>
        </div>
        ...
        {/* Related Products */}
        <div className="mt-16">
          <h2 className="font-[family-name:var(--font-poppins)] font-semibold text-2xl text-[#141414] mb-8">
            You May Also Like
          </h2>
            ...
            {productsData.slice(0, 4).filter(p => p.id !== product.id).slice(0, 4).map((relatedProduct) => (
              <Link key={relatedProduct.id} href={`/product/${relatedProduct.id}`}>
                <div className="bg-white rounded-lg overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
                  <div className="bg-[#f5f7ff] h-[200px] overflow-hidden">
                    <img 
                  ...
                  <div className="p-4">
                    <h3 className="font-[family-name:var(--font-poppins)] font-medium text-base text-[#141414] mb-2 line-clamp-2">
                      {relatedProduct.title}
                    </h3>
                    <div className="flex items-center gap-2">
                      <p className="font-[family-name:var(--font-poppins)] font-semibold text-lg text-black">
                        £{relatedProduct.price}
                      </p>
                      <p className="font-[family-name:var(--font-poppins)] text-sm text-[#888] line-through">
